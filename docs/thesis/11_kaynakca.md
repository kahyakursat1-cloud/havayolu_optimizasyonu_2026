...
Levine, D. (1996). Application of a hybrid genetic algorithm to airline crew scheduling. *Computers & Operations Research*, 23(6), 547–558. https://doi.org/10.1016/0305-0548(95)00061-5
...
Stojković, G., Soumis, F., Desrosiers, J., & Solomon, M. M. (2002). An optimization model for a real-time flight scheduling problem. *Transportation Research Part A*, 36(9), 779–788. https://doi.org/10.1016/S0965-8564(01)00036-3
...
National Oceanic and Atmospheric Administration. (2024). *AviationWeather.gov API documentation*. https://aviationweather.gov/data/api/
