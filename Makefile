...
test:
	cd src && PYTEST_DISABLE_PLUGIN_AUTOLOAD=1 ./.venv/bin/python -m pytest -q ../tests/test_core.py ../tests/test_solver.py ../tests/test_integration.py ../tests/test_models.py
